...
class MedicalGuardrailsService:
    ...
    async def initialize(self) -> None:
        ...
        try:
            if not self._config_path.exists():
                raise FileNotFoundError(f"Guardrails config directory not found: {self._config_path}")
        ...
        try:
            ...
            if result and 'content' in result:
                ...
                if filtered_text != text:
                    logger.info("Input filtering applied: sensitive information detected and masked")
    ...
    async def filter_output(self, text: str) -> str:
        ...
        try:
            ...
            if result and 'content' in result:
                ...
                # Log if sensitive information was detected and masked
                if filtered_text != text:
                    logger.info("Output filtering applied: sensitive information detected and masked")
    ...
    async def validate_content(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message": "Content validated for privacy compliance" if len(violations) == 0 else f"Found {len(violations)} potential privacy violations"
            }
    ...
    def is_available(self) -> bool:
        ...
        return (
            ...
            (self._config_path / "config.yml").exists() and
            (self._config_path / "prompts.yml").exists()
        )
